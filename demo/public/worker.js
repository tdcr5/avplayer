(function (global, factory) {
  ...
  if (self.name === 'simd') {
    Promise.resolve().then(function () { return decoder_simd$1; }).then(module => {
      Module = module.default;
      loadAll();
    });
  } else {
    Promise.resolve().then(function () { return decoder$1; }).then(module => {
      Module = module.default;
      loadAll();
    });
  }
  ...
  var decoder_simd$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    'default': decoder_simd,
    __moduleExports: decoder_simd
  });
